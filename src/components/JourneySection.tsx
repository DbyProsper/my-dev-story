  ...
  const milestones = [
    {
      year: '2019',
      title: 'The Spark',
      description: 'Wrote my first "Hello World" and got hooked. What started as curiosity became a passion that would change everything.',
      icon: <Lightbulb className="w-6 h-6" />,
    },
    {
      year: '2020',
      title: 'Deep Dive',
      description: 'Mastered HTML, CSS, and JavaScript. Built countless projects, broke things, fixed them, and learned the beauty of clean code.',
      icon: <Code className="w-6 h-6" />,
    },
    {
      year: '2021',
      title: 'Framework Era',
      description: 'Discovered React and fell in love with component-based architecture. Started building real-world applications that actually helped people.',
      icon: <Rocket className="w-6 h-6" />,
    },
    {
      year: '2022',
      title: 'Full-Stack Journey',
      description: 'Expanded into backend development with Node.js and databases. Understanding the full picture made me a better developer.',
