...
const projects: Project[] = [
  ...
  },
  {
    id: 2,
    title: 'CodeSnap',
    description: 'Beautiful code snippet sharing with syntax highlighting and custom themes.',
    longDescription: 'CodeSnap allows developers to share beautiful code snippets with customizable themes, export options, and social sharing capabilities.',
    problem: 'Sharing code on social media often results in poorly formatted, hard-to-read screenshots.',
    solution: 'Created a canvas-based renderer that produces pixel-perfect code images with proper syntax highlighting and customizable backgrounds.',
    tech: ['Next.js', 'Canvas API', 'Prism.js', 'Tailwind CSS'],
